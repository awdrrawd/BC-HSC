...
// ════════════════════════════════════════
    ...
    // 可選語言（auto = 依遊戲語系）
    const HSC_LANGS = ['auto', 'TW', 'CN', 'EN', 'JA', 'KO', 'DE', 'FR', 'ES', 'VI', 'RU', 'UA'];
    ...
    const HSC_LANG_FLAGS = { auto: '🌐', TW: '🇹🇼', CN: '🇨🇳', EN: '🇬🇧', JA: '🇯🇵', KO: '🇰🇷', DE: '🇩🇪', FR: '🇫🇷', ES: '🇪🇸', VI: '🇻🇳', RU: '🇷🇺', UA: '🇺🇦' };
    const HSC_LANG_NAMES = { auto: 'Auto', TW: '繁體中文', CN: '简体中文', EN: 'English', JA: '日本語', KO: '한국어', DE: 'Deutsch', FR: 'Français', ES: 'Español', VI: 'Tiếng Việt', RU: 'Русский', UA: 'Українська' };
    ...
    const HSC_FALLBACK = {
        ...
        hypnoLabel: '催眠值', hypnoD: '收到催眠時累積的催眠值（0~100，每 12 秒 -1）。到 100% 進入強控；強控後依自動清醒倒數或清醒詞解除，催眠值歸 0。',
        hypnoVoiceLabel: '語音催眠值', hypnoVoiceD: '每次語音催眠增加（0~20，0＝停用）。',
        hypnoDepthLabel: '深度催眠值', hypnoDepthD: '每次深度催眠增加（0~10，0＝停用）。',
        sec_wakeWord: '清醒詞', wakeWordD: '房內「他人」說出此詞→你立即清醒且催眠值歸 0；自己說無效。每行一個。', wakeWordPh: '例：wake',
